    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
               ...
               Notification emailSending= new Notification();
               emailSending.sendPassword(user.Email, callbackUrl);
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            if (user == null)
            {
                ...
                return RedirectToAction("ResetPasswordFailedConfirmation");
        ...
        public ActionResult ResetPasswordFailedConfirmation()
        {
            return View();
        }
    }
